...
public:
    ...
    SharedLinkInterfacePtr mavlinkPixhawkLink();

    /// Returns pointer to the mavlink forwarding link, or nullptr if it does not exist
    SharedLinkInterfacePtr mavlinkForwardingLink();

    /// Returns pointer to the mavlink forwarding link, or nullptr if it does not exist
    SharedLinkInterfacePtr mavlinkAutoconnectLink();

    SharedLinkInterfacePtr mavlinkPrimaryUDPLink();
    SharedLinkInterfacePtr mavlinkSecondaryUDPLink();
    ...
    void addPrimaryUDPLinkHost(const QString &url);
    void addSecondaryUDPLinkHost(const QString &url);
...
private:
    ...
    static constexpr const char *_defaultPrimaryUDPLinkName = "_primaryUDPLink";
    static constexpr const char *_defaultSecondaryUDPLinkName = "_secondaryUDPLink";
